...
func TestUserService_GetByID(t *testing.T) {
	...
	t.Run("CacheMissDBSuccess", func(t *testing.T) {
		...
		// 设置期望
		mockCache2.On("GetObject", ctx, cacheKey, mock.AnythingOfType("*model.User")).Return(errors.New("cache miss"))
	...
	t.Run("UserNotFound", func(t *testing.T) {
		...
		// 设置期望
		mockCache3.On("GetObject", ctx, cacheKey, mock.AnythingOfType("*model.User")).Return(errors.New("cache miss"))
